...
export default function BottomSection({ loading = false }: Props) {
  if (loading) {
    return (
      <div className="flex flex-col lg:flex-row gap-6 items-stretch animate-pulse">
        ...
        <div className="flex-1 bg-neutral-800 rounded-xl border border-neutral-50/10 p-6 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg border border-neutral-50/10">
          ...
          <div className="flex-1 bg-neutral-800 rounded-xl border border-neutral-50/10 p-6 flex flex-col gap-4">
            ...
            <div className="flex justify-between pt-2">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="h-3 w-8 bg-neutral-700 rounded"></div>
              ))}
            </div>
          </div>

          <div className="bg-neutral-800 rounded-xl border border-neutral-50/10 p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-neutral-700 rounded"></div>

              <div className="space-y-2">
                <div className="h-3 w-28 bg-neutral-700 rounded"></div>
                <div className="h-2 w-36 bg-neutral-700 rounded"></div>
              </div>
            </div>
    ...
    <div className="flex flex-col lg:flex-row gap-6 items-stretch">
      ...
      <div className="flex-1 bg-neutral-800 rounded-xl border border-neutral-50/10 p-6 flex flex-col gap-6">
        ...
        <div className="text-sm text-neutral-400 space-y-1">
          <p>
            <span className="font-medium text-white">Schedule:</span> Bi-weekly
            (Every 2nd Friday)
          </p>
          <p>
            <span className="font-medium text-white">Next Payout:</span> Nov 15,
            2025
          </p>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-slate-100 rounded">
                <FileText size={18} className="text-neutral-800" />
              </div>
